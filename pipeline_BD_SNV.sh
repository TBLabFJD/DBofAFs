...
mymetadatapathology_uniq="/home/proyectos/bioinfo/NOBACKUP/graciela/TODO_DBofAFs/PRUEBAS_DBofAFs/metadata/all_FJD.tsv" #varias cat y varias subcat TODOS CES Y WGS Y WES
# Task directory
